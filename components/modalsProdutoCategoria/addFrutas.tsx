...
export function AddFrutas({ fecharModalCategoria, adicionarProdutos }) {
  ...
  useEffect(() => {
    const carregarProdutos = async () => {
      try {
        ...
        produtosFrutas.forEach(produto => {
  ...
  return (
    <View style={estiloModalEspecifico.container}>
      <View style={estiloModalEspecifico.content}>
        <Text style={estiloModalEspecifico.titulo}>Frutas</Text>
        <FlatList
          data={produtos}
